...
describe Bonobot::Configuration do
  ...
  describe "#excluded_files" do
    it "returns the correct value" do
      expect(configuration.instance_variable_get(:@excluded_files)).to eq([])
    end
  end
  ...
  context "when config file is present" do
    ...
    let(:excluded_files) { ["spec_helper.rb"] }
    ...
    describe "#excluded_files" do
      it "returns the correct value" do
        expect(configuration.instance_variable_get(:@excluded_files)).to eq(["spec_helper.rb"])
      end
    end
